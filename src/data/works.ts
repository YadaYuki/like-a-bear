...
export const Works: WorkType[] = [
  {
    wordId: "dark-patterns-in-e-commerce",
    title:
  ...
  {
    wordId: "search-engine-omochi",
    title: "Omochi: Full text search engine from scratch in Golang",
    category: "OSS",
    description:
      "Omochi is an inverted index based search engine by Golang. If indexed correctly, any text-based documents can be searched. You can search documents from RESTful API. Supported language: English, Japanese.",
  ...
  },
  {
    ...
    category: "OSS",
    description:
      "Nand2tetris is a unique project that allows you to build a complete computer system from scratch, starting with nothing but a Nand gate. By following the step-by-step instructions provided in the project, you will be able to create your own computer hardware, design a programming language, and write software programs to run on your custom-built computer. Through this hands-on approach, you will gain a deep understanding of how modern computers work, including hardware, compilers, and assembly. The project is divided into several chapters, each of which covers a different aspect of computer design and programming.",
    githubUrl: "https://github.com/YadaYuki/Omochi",
    blogUrl: "https://zenn.dev/yukiyada/articles/7e2c67d8406f0d",
  },
  {
    wordId: "neural-net-typescript",
    title:
    ...
    blogUrl: "https://zenn.dev/yukiyada/articles/053722ddadd18a",
  },
  {
    wordId: "neural-net-golang",
